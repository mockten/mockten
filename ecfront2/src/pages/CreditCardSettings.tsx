...
const CreditCardSettings: React.FC = () => {
  ...
  const VisaLogo: React.FC<{ width?: number; height?: number }> = ({
    width = 48,
    height = 20,
  }) => (
    <Box
  ...
  const Jcb: React.FC<{ width?: number; height?: number }> = ({
    width = 48,
    height = 20,
  }) => (
    <Box
  ...
  const Diners: React.FC<{ width?: number; height?: number }> = ({
    width = 48,
    height = 20,
  }) => (
    <Box
  ...
  const Amex: React.FC<{ width?: number; height?: number }> = ({
    width = 48,
    height = 20,
  }) => (
    <Box
  ...
  const Discover: React.FC<{ width?: number; height?: number }> = ({
    width = 48,
    height = 20,
  }) => (
    <Box
